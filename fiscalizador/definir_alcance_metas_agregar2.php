...
$id = $_POST['alcance_componente'];


$sql = "SELECT * FROM Listar_Metas WHERE ID=$id";
$result = mysqli_query($con, $sql);   
if ($result) {
    $alcance = mysqli_fetch_assoc($result);
}
?>
        ...
        <div class="container">            
            ...
            <div class="panel">
                ...
                <div class="contenido">
                    ...
                    <form method="post" action="definir_alcance_metas_agregar3.php">

                        <?php
                            echo "<input type=\"hidden\" name=\"id\" value=\"".$_POST['alcance_componente']."\">";
                        ?>
                    
                        <div class="items">
                            <label for="alcance_descripcion">Descripción de la meta:</label>
                            <textarea name="alcance_descripcion"id="alcance_descripcion" rows="5" cols="50" readonly><?php echo $alcance['Descripcion'] ?></textarea>
                        </div>
                        </br>

                        <div class="items">
                            <label for="alcance_descripcion_propia">Descripción para el alcance:</label>
                            <textarea name="alcance_descripcion_propia" id="alcance_descripcion_propia" rows="5" cols="50" placeholder="Ingrese la descripción del alcance..."></textarea>
                        </div>
                        </br>

                        <input type="submit" value="Siguiente" class="submit">
                        <input type="button" class="submit" onclick="location.href='definir_alcance_metas_agregar.php' "value="Volver" />
