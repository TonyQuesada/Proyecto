    ...
    <body>
        ...
        <div class="container">            
            ...
            <div class="panel">
                ...
                <div class="contenido">
                <p>ID Usuario: <input type="text" name="id_usuario"/></p>
                <p>Rol principal: <select name="id_rol">
                <option>Rol</option>
                <option>Director de área</option>
                <option>Fiscalizador</option>
                <option>Encargado de departamento</option>
                <option>Empleado</option>
                </select></p>
                
                
                <p>Rol secundario: <select name="id_subrol">
                <option>Rol</option>
                <option>Empleado</option>
                </select></p>

                <p>Dirección: <select name="id_direccion">
                <option>Administracion y finanzas</option>
                <option>Gerencia de Marketing</option>
                <option>Gerencia de Proyectos</option>
                </select></p>

                <p>Departamento: <select name="id_departamento">
                <option>Talento Humano</option>
                <option>Publicidad</option>
                <option>Administracion de Nuevos Proyectos</option>
                </select></p>
