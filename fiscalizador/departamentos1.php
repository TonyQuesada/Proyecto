    ...
    <body>
        ...
        <div class="container">            
            ...
            <div class="panel">
                ...
                <p>Seleccione el departamento:    <input type="text" name="nombre_departamento"/></p>
                <p>Encargado: <input type="text" name="id_encargado"/></p>
                <p>Nuevo nombre:    <input type="text" name="nombre_departamento"/></p>
                <p>Nuevo encargado: <input type="text" name="id_encargado"/></p>
