        ...
        <div class="container">            
            ...
            <div class="panel">
                ...
                <div class="contenido" style="padding-bottom: 55px;">
                    ...
                    <form method="post" action="../util/metas_modificar.php">
                        ...
                        <div class="items">
                            <label for="metas_componente_nueva">Seleccione el componente:</label>
                        </div>

                        <div class="items">
                            <select class="select-css" name="metas_componente_nueva" id="metas_componente_nueva">                                
                                <?php
                        ...
                        <div class="items">
                            ...
                            <textarea name="meta_descripcion_nueva" id="meta_descripcion_nueva" rows="4" cols="50" placeholder="Ingrese la descripción de la meta..."><?php echo $metas["Descripcion"]?></textarea>      
                        </div>
